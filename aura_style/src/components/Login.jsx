...
// import { TextField, Button, Typography, Container, Grid, Box, FormControl, InputLabel, Select, MenuItem } from '@mui/material';
...
//             dispatch(loginFailure({ error: "login unsuccessful" }));
    ...
    const handleSubmit = async (values, { setSubmitting }) => {
        try {
            const dataToSend = {
                ...
                role: role // Use the role state variable here
            };
    
            
        
            const response = await axios.post( `${apiUrl}/Login`, dataToSend, {
                headers: {
                    'Content-Type': 'application/json',
